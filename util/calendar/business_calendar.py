...
class Calendar:
    ...
    def _adjust_following(self, date: datetime) -> datetime:
        ...
        if iterations >= max_iterations:
            raise ValidationError(f"Could not find business day within {max_iterations} days")
...
def create_calendar(calendar_type: CalendarType, year_range: tuple = (2020, 2030)) -> Calendar:
    """
