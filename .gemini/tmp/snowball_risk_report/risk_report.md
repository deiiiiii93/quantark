...
**Risk Interpretation**: [ADD INTERPRETATION: e.g., The product is currently in a knock-out likely. Main risk is theta decay.]

## 2. Product & Market Snapshot
- **Engine used**: `quad`
- **Pricing Mode**: finite-difference
- **PV (Base)**: 0.918595
- **Spot S0**: 100.000000
...
- **Dividend / Basis Risk**: Basis mapping (China index futures): define carry/basis `b = r - q`, so `RhoB = ∂V/∂b = -∂V/∂q = -RhoQ`.
...
- smile: 0.050000
- PV impact: 0.000000
- **Higher-Order Time Greeks**: - `plots/charm_spot_div.png`, `plots/color_spot_div.png`
...
- Vol shocks: -5%, 0%, +5%
- **Worst Case**: -20% spot × +5% vol results in PnL of **-18.329304**.
...
**Interpretation**: Risk is concentrated in the 1Y (0.5-1y) bucket.
...
**Interpretation**: Stress tests indicate the product fails basic resilience checks at a 50% equity loss threshold.
