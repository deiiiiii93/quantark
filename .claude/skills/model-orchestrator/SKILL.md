...
Proposal triggers:
- `/openspec:proposal` skill invocation
...
| Step | Skill | Type |
|------|-------|------|
| 3 | model-researcher | User-scoped |
| 4 | model-developer | Project-scoped |
| 5 | model-logic-validator | Project-scoped |
| 6a | code-performance-reviewer | User-scoped |
| 6b | code-security-checker | User-scoped |
| 6c | code-simplifier | User-scoped |
