...
def test_slv_pde_cs_reference_values():
    ...
    # corrected-CS + implicit-rU scheme and the 2026-08-03 monotone variance
    # stencil.  Only the Douglas put activates the adaptive-upwind fallback on
    # this grid; the other pins therefore remain at their centered-stencil values.
    ...
    PINS = (9.52886663568638, 12.617957757194208,
