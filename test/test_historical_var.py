...
from quantark.var import VaRConfig, VaRMethod
from quantark.var.engines import HistoricalVaREngine
...
def test_historical_var_calculation(sample_portfolio, sample_historical_data):
    ...
    assert len(result.scenarios) == 300  # Matches sample_historical_data fixture
