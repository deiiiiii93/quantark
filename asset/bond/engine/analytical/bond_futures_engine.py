...
class BondFuturesEngine:
    ...
    def price(
        ...
        if calculate_greeks:
            ...
            mod_dur = self._calculate_futures_duration(
                theoretical_price, dv01
            )
    ...
    def _calculate_carry(
        ...
        # Financing cost
        financing_cost = dirty_price * (
            math.exp(self.repo_rate * time_to_delivery) - 1
        )
    ...
    def _calculate_futures_duration(
        self,
        futures_price: float,
        dv01: float
    ) -> float:
    ...
    def _calculate_futures_convexity(
        ...
        results_down = engine_down.price(futures, valuation_date, calculate_greeks=False)
    ...
    def analyze_basis(
        ...
        for ba in results.bond_analyses:
            ...
            analysis = {
                ...
                "is_ctd": ba.is_ctd,
                "delivery_value": ba.invoice_price - ba.dirty_price if ba.is_ctd else None
            }
    ...
    def find_delivery_option_value(
        ...
        # Average price
        avg_price = sum(theoretical_prices) / len(theoretical_prices) if theoretical_prices else 0
    ...
    def __repr__(self):
        return (f"BondFuturesEngine(valuation_date={self.pricing_env.valuation_date.date()}, "
