...
## Purpose
Provides tree-based (binomial and trinomial) pricing engines for convertible bonds. These engines implement the Goldman Sachs credit-adjusted binomial model and the Hull-White trinomial model with default probability. Tree methods are intuitive, handle American-style early exercise naturally, and provide good accuracy for most convertible bond structures.
