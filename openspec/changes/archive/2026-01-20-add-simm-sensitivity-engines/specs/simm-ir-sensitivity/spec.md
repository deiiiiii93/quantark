# SIMM Interest Rate Sensitivity

This capability provides Interest Rate sensitivity calculation for SIMM, including delta (PV01), inflation, cross-currency basis, vega, and curvature sensitivities.
