# Engine Enums - Greeks Calculation Mode

This capability provides the `GreeksCalculationMode` enum for controlling how delta and gamma are calculated in `GreeksCalculator`.
