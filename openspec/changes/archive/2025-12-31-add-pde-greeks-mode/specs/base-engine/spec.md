# Base Engine - Engine Type Attribute

This capability provides an `engine_type` attribute on `BaseEngine` for easy engine type detection, enabling `GreeksCalculator` to intelligently choose between bump method and engine-built-in Greeks.
