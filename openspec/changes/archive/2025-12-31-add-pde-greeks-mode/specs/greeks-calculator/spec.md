# Greeks Calculator - PDE Greeks Mode

This capability provides configurable delta/gamma calculation mode in `GreeksCalculator`, allowing users to choose between bump method (finite difference) and engine-built-in methods (e.g., PDE grid-based Greeks).
