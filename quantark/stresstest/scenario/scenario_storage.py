...
class ScenarioStorage:
    ...
    @staticmethod
    def save_scenarios(
        scenarios: List[Scenario], filepath: Union[str, Path], format: str = "auto"
    ) -> None:
        """
        ...
        data = {"version": "1.0", "scenarios": [s.to_dict() for s in scenarios]}
    ...
    @staticmethod
    def save_scenario(
        scenario: Scenario, filepath: Union[str, Path], format: str = "auto"
    ) -> None:
        """
    ...
    @staticmethod
    def load_scenario(
        filepath: Union[str, Path], format: str = "auto", scenario_index: int = 0
    ) -> Scenario:
        """
    ...
    @staticmethod
    def create_template(filepath: Union[str, Path], format: str = "yaml") -> None:
        """
