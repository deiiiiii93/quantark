...
@dataclass
class FXBacktestResults:
    """Per-step history and summary metrics for an FX backtest."""
    ...
    def get_summary(self) -> str:
        ...
        return (
            f"FX Backtest: {self.config_summary.get('strategy', '?')}\n"
    ...
    def __repr__(self) -> str:
        return (
            f"FXBacktestResults(steps={len(self.rows)}, hedges={self.num_hedges}, "
